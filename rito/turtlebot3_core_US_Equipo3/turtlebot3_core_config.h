...
#include <sensor_msgs/Range.h> // Message for Ultrasound sensor
...
#define ULTRASOUND_PUBLISH_FREQUENCY           50   //hz  
...
void publishWeightMsg(void); // ULtrasound sensor
...
float getWeight(); // For Ultrasound sensor
...
ros::Publisher pub_range( "/weight", &range_msg);
